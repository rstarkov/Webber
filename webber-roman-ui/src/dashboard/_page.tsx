...
export function DashboardPage(): JSX.Element {
    ...
    return (
        <>
            ...
            <SunTimes style={{ position: 'absolute', left: '59vw', top: '51vh' }} />
            <MainClock style={{ position: 'absolute', left: '41vw', top: '-5vh', width: '27vw' }} onClick={() => document.body.requestFullscreen()} />
            ...
            <BlockPanelContainer state={ping} style={{ position: 'absolute', left: 0, top: '80vh', width: '7vw' }}>{ping.dto?.last}</BlockPanelContainer>
        </>
    )
}
